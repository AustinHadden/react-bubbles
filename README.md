...
- [ ] Explain what a token is used for.
  ...
  It is used to tell the server that you have permission to do certain things.

- [ ] What steps can you take in your web apps to keep your data secure?

  Require tokens to access certain sections of the app.

- [ ] Describe how web servers work.

  They hold code for different web apps to be accessed by people through the internet.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  PUT and DELETE are the U and D in the acronym.
